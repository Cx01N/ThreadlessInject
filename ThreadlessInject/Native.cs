...
namespace ThreadlessInject
{
    public static class Native
    {
        ...
        public static NTSTATUS ProtectVirtualMemory(IntPtr hProcess, IntPtr address, uint size, Win32.MemoryProtection newProtection,
            out Win32.MemoryProtection oldProtection)
        {
        ...
        public static NTSTATUS FreeVirtualMemory(IntPtr hProcess, IntPtr address)
        {
            ...
            return NtFreeVirtualMemory(
                ...
                ref address,
                ref regionSize,
                Win32.MemoryAllocation.Release);
        }
        ...
        private static extern NTSTATUS NtAllocateVirtualMemory(
            ...
            Win32.MemoryAllocation allocationType,
            Win32.MemoryProtection memoryProtection);
        ...
        private static extern NTSTATUS NtProtectVirtualMemory(
            ...
            Win32.MemoryProtection newProtect,
            out Win32.MemoryProtection oldProtect);
        ...
        private static extern NTSTATUS NtFreeVirtualMemory(
            ...
            ref IntPtr baseAddress,
            ref UIntPtr regionSize,
            Win32.MemoryAllocation freeType);
